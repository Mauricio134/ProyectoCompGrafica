...
void main()
{
	...
	vec3 light_position = vec3(0.0, 0.0, 30.0); // A position used as a light source acts as a point light (Not a directional light)
	...
	float ambient_factor = 0.4; // Intensity multiplier.
